<nav class="c-hamburger js-toggle-sp-menu-target">
    ...
    <ul class="c-hamburger__menu">
      ...
      <li class="c-hamburger__list js-nav-close"><a class="c-hamburger__link" href="/#main">最新クチコミ</a></li>
      <li class="c-hamburger__list js-nav-close"><a class="c-hamburger__link" href="/#sprank">アクセスランキング</a></li>
    </ul>
  </nav>
